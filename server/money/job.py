...
from main.models import db, Business_user
...
@money.route('/business', methods=['POST'])
def business_user():
...
@money.route('/getbusiness', methods=['POST'])
def getbusiness():
...
@money.route('/business_update', methods=['PUT'])
@jwt_required()
...
@money.route('/business_password', methods=['PUT'])
@jwt_required()
@role_required("business_owner")
def bus_password():
...
@money.route('/delete_business', methods=['DELETE'])
@jwt_required()
@role_required("business_owner")
def delete_business():
